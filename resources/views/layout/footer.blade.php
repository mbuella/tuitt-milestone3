<footer class="container navbar-static-bottom">
	<div class="row">
		<div class="col-md-3 col-sm-6 col-xs-12 col-md-push-9 col-sm-push-6" id="footer-right">	
				<div id="social">	
					<a href="#">
		...
		<div class="col-md-9 col-sm-6 col-xs-12 col-md-pull-3 col-sm-pull-6" id="footer-left">	
			<div id="copyright">
